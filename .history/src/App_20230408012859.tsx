    ...
    <div className="container md:w-[100%] ">
      ...
      <div className="flex justify-center flex-wrap flex-row  ">
      {
        products.map((product) => (
          ...
          <div key={product.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  m-2 w-full xl:w-[25%] md:w-[48%]">
              <img className="rounded-t-lg w-full h-[200px]" src={product.image} alt="" />
              <div className="p-3">
                  <a href="#">
