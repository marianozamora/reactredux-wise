        ...
        products.map((product) => (
          ...
          <div key={product.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  m-2 w-full xl:w-[30%] lg:w-[48%]">
            <div 
              ...
              <div className="p-3">
                  <a href="#">
                    <h5 className="flex items-center align-middle justify-center mb-2 min-h-[80px] text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{ product.title }</h5>
              </a>
