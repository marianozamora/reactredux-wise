    ...
    <div className="md:container md:mx-auto ">
      ...
      <div className="flex justify-center flex-wrap flex-row  ">
      {
        ...
        <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-500 dark:focus:ring-green-800">Buy this item</a>
        </div>
